...
import com.junpu.topdf.utils.SimpleAnimatorListener
...
class LinearProgressBar : View {
    ...
    private val defaultProgressBackgroundColor = Color.parseColor("#00000000") // 默认背景颜色
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        // 画背景
        canvas?.drawLine(0f, startY, width.toFloat(), startY, backgroundPaint.apply { color = progressBackgroundColor })
        // 画进度
        val progressWidth = width * progress / max.toFloat()
        canvas?.drawLine(0f, startY, progressWidth, startY, progressPaint.apply { color = progressColor })
        // 画阴影
    ...
    fun setProgressByAnimator(progress: Int, callBack: ((Int) -> Unit)? = null) {
