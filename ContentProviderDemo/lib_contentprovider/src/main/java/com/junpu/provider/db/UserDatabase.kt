...
import com.junpu.provider.ProviderConstact.ProviderColumns.KEY_AGE
import com.junpu.provider.ProviderConstact.ProviderColumns.KEY_ID
import com.junpu.provider.ProviderConstact.ProviderColumns.KEY_NAME
import com.junpu.provider.ProviderConstact.ProviderColumns.KEY_SEX
import com.junpu.provider.ProviderConstact.ProviderColumns.TABLE_NAME

class UserDatabase(context: Context?) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION), IUserDatabase {
